...
def number_of_underscore
    counter = 0
    $liste_journalistes.each do |handle|
        handle.each_char do |character|
...
def perform
    ...
    contains_number
    contains_aude
    begin_with_uppercase
    have_uppercase
    number_of_underscore 
    alphabetic_order
end 

#Lance la méthode perform
perform
